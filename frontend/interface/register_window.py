...
class RegisterWindow(BaseWindow):
    ...
    def create_widgets(self):
        ...
        self.label = ttk.Label(self, text='Cadastro de Usuário', font=('Arial', 30), background='#C0C0C0') 
        self.label.pack(pady=20)
        
        
        self.label2 = ttk.Label(self, text='Preencha os campos abaixo para criar uma conta.', font=("Arial", 16), background='#C0C0C0')
        self.label2.pack(pady=20)
        
        
        
        self.name_label = ttk.Label(self, text='Nome:', font=('Arial', 16), background='#C0C0C0')
    ...
    def register_user(self):
        ...
        if register == 'E-mail-inválido':
            ...
            messagebox.showerror('Erro', 'Esse CPF já está cadastrado.')
        else:
